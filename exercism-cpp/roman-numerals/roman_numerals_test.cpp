...
TEST_CASE("7_is_vii") { REQUIRE("VII" == roman_numerals::convert(7)); }
TEST_CASE("8_is_viii") { REQUIRE("VIII" == roman_numerals::convert(8)); }
TEST_CASE("9_is_ix") { REQUIRE("IX" == roman_numerals::convert(9)); }
TEST_CASE("10_is_x") { REQUIRE("X" == roman_numerals::convert(10)); }
